...
@DataJpaTest //anotación pa cuando queremos hacer test q necesitan de la capa de persistencia/levantan contexto Spring
...
class MedicoRepositoryTest {
    ...
    void elegirMedicoAleatorioDisponibleEnLafechaEscenario1() {
        //given o arrange
        var lunesSiguienteAlas10 = LocalDate.now().with(TemporalAdjusters.next(DayOfWeek.MONDAY))
                .atTime(10, 0);
        var medico = registrarMedico("Medico1", "medico@gmail.com", "12345", Especialidad.CARDIOLOGIA);
        var paciente = registrarPaciente("Paciente1", "paciente@gmail.com", "12378");
        ...
        //then o assert
        assertThat(medicoLibre).isNull();// deberia devolver null, porque no encontrara medicos disponibles
        //                                  en la fecha indicada(bd test)
    ...
    void elegirMedicoAleatorioDisponibleEnLafechaEscenario2() {
        ...
        var lunesSiguienteAlas10 = LocalDate.now().with(TemporalAdjusters.next(DayOfWeek.MONDAY))
                .atTime(10, 0);
        var medico = registrarMedico("Medico1", "medico@gmail.com", "12345", Especialidad.CARDIOLOGIA);
//        registrarConsulta(medico, paciente, lunesSiguienteAlas10);//necesitamos al medico libre


        //when o act
        var medicoLibre = medicoRepository.elegirMedicoAleatorioDisponibleEnLafecha(Especialidad.CARDIOLOGIA, lunesSiguienteAlas10);
        //then o assert
        assertThat(medicoLibre).isEqualTo(medico);// deberia devolver el medido que registramos antes
